...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm opacity-10 text-dark">Comprobantes</li>
                    </ol>
                </nav>
                        ...
                        <div class="d-flex m-1">
                            <div class="ms-auto d-flex">
                                ...
                                <div class="ps-4">
                                    ...
                                    <!-- <button type="button" class="btn bg-gradient-info btn-icon-only mb-0 mt-3" data-toggle="modal" data-target="#modal_ver_comprobante"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    ...
                                    <div class="card-body px-0 pt-0 pb-2">
                                        <div class="table-responsive p-0">
                                            <table class="table align-items-center mb-0 table table-striped table-bordered" id="asistencia-list">
                                                <thead>
                                                    <tr>
                                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width: 20%;">Usuario</th>
                                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width: 40%;">Conceptos</th>
        ...
        <div class="modal fade" id="modal_ver_comprobante" role="dialog" aria-labelledby="asignar_habitacionLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">

                    <div class="modal-header">
                        <h5 class="modal-title" id="asignar_habitacionLabel">Comprobante</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body pt-0">
                            ...
                            <input type="text" id="_url_archivo" name="_url_archivo" value="">
                            <input type="text" name="user_id" id="user_id" value="">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <iframe src="" frameborder="0" id="iframe_comprobante" style="width: 100%; height: 500px;"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn bg-gradient-success" id="btn_aceptar" name="btn_aceptar">Aceptar</button>
                        <button type="submit" class="btn bg-gradient-danger" id="btn_rechazar" name="btn_rechazar">Rechazar</button>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn_ver_comprobante").on("click", function() {
            ...
            $("#iframe_comprobante").attr('src', 'http://localhost:8124/comprobantesPago/' + url_archivo);
            $("#_url_archivo").val(url_archivo);
            $("#user_id").val(user_id);
        })

        $("#btn_aceptar").on("click", function() {
            var url_archivo = $("#_url_archivo").val();
            var user_id = $("#user_id").val();
            var status = 1;
            var msg = "Se va a aceptar el comprobante";

            cambiarStatus(url_archivo,status,user_id,msg);
        ...
        $("#btn_rechazar").on("click", function() {
            ...
            var user_id = $("#user_id").val();
            var status = 2;
            var msg = "Se va a rechazar el comprobante";
        ...
        function cambiarStatus(url_archivo,status,user_id,msg) {
            Swal.fire({
                title: msg,
                text: "",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/ComprobantesPago/cambiarStatus",
                        type: "POST",
                        data: {
                            url_archivo,status,user_id
                        },
                        // dataType: 'json',
                        beforeSend: function() {
                        ...
                        success: function(respuesta) {
                            ...
                            if(respuesta == 'success'){
                                Swal.fire('Operación realizada exitosamente','','success');
                                setTimeout(() => {
                                    location.reload();
                                }, 2000);
                            }else{
                                Swal.fire('Hubo un error al realizar la operación','','success');
                            }
