            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm opacity-10 text-dark">Validación</li>
                    </ol>
                </nav>
                <!-- TOGGLER 
                    ...
                    <div class="row gx-4">
                        <div class="col-auto">
                            <div class="bg-gradient-pink avatar avatar-xl position-relative">
                                ...
                                <span class="fas fa-clipboard-check" style="font-size: xx-large;"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12 mt-4 mt-md-0">
                                            <h6 class="" style="text-align: center;">Seleccione una opción</h6>
                                                ...
                                                <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link mb-0 px-0 py-1" href="#cam4" data-bs-toggle="tab" role="tab" aria-selected="false">
                                                            ...
                                                            <span class="ms-1">Liberados</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="cont_total_gafetes" style="padding: 20px;">
                                        <span style="font-size: 25px; color:green;">Número de usuarios pendientes de subir comprobante: <span id="total_gafetes"><?=number_format($total_gafetes)?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="cont_total_consta" style="padding: 20px;">
                                        <span style="font-size: 25px; color:green;">Número de usuarios a liberar: <span id="total_consta"><?=number_format($total_consta)?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="cont_total_consta" style="padding: 20px;">
                                        <span style="font-size: 25px; color:green;">Usuarios Liberados: <span id="total_socios"><?=number_format($total_socios)?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#validacion a').addClass('active');
        $('#validacion .fa-clipboard-check').addClass('text-white');
...
<script type="text/javascript">
		...
		$(document).ready(function() {
			$(document).on('click', '.pdf-español', function() {
				...
				var url = "https://registro.dualdisorderswaddmexico2022.com/comprobantesPago/" + id
		...
		$(document).ready(function() {
			$(document).on('click', '.pdf-ingles', function() {
				var id = $(this).val();
				console.log('El código es: ' + id);
				var url = "https://register.dualdisorderswaddmexico2022.com/comprobantesPago/" + id
