                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="card mb-4">
                                            ...
                                            <table class="table align-items-center mb-0 table table-striped table-bordered" id="table_caja">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tipo Moneda</th>
                                    ...
                                    <div class="cont_total_usd" style="padding: 20px;">
                                        <span style="font-size: 25px; color:green;">Total: $ <span id="total_dolares"><?= number_format($total_dolares, 2) ?></span> USD</span>
                                    </div>
