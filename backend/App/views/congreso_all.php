            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm opacity-10 text-dark">Congreso</li>
                    </ol>
                </nav>
                    ...
                    <div class="row gx-4">
                        <div class="col-auto">
                            <div class="bg-gradient-pink avatar avatar-xl position-relative">
                                ...
                                <span class="fa fa-user-graduate" style="font-size: xx-large;"></span>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    <form class="form-inline my-2 my-lg-0" action="/Congreso/Usuario" method="post">
                                        <div class="row">
