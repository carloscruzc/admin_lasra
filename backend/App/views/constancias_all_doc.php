                                        ...
                                        <div class="col-lg-12 col-sm-6">
                                            <div class="card h-100">
                                                <div class="card-header pb-0 p-3">
                                                    ...
                                                    <div class="col">
                                                        <p>Nota : Puedes buscar tu constancia por tu número de gafete, correo electrónico ó tu nombre completo.</p>
                                                    </div>
                                                    </div>
        ...
        $(document).ready(function() {
            ...
            function contCards(respuesta) {
                ...
                if(respuesta.no_cards > 0){
                    ...
                    $("#cont_cards").html(`<div class="row mt-3 p-3">
                                                        <div class="col-md-12">
                                                            <p>Parece que no tienes acceso a las constancias.</p>
                                                        </div>
