...
class PruebasCovidUsuarios implements Crud{
    public static function getAll(){
        ...
        $query =<<<sql
        SELECT pc.id_prueba_covid AS id_c_v, pc.utilerias_asistentes_id, pc.status AS status_prueba, pc.resultado, pc.tipo_prueba, fecha_carga_documento, tipo_prueba, pc.nota, resultado, email, telefono, documento,  CONCAT(ra.nombre,' ',ra.apellido_paterno,' ',ra.apellido_materno) AS nombre_completo,
