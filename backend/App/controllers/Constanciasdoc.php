...
html;
    ...
    public function getConstancias()
    {
        ...
        if (is_numeric($_POST['id_gafete'])) {
            ...
            $constancia_general = AsistentesDao::getCongresoByUserEmail($email_user);
        }
...
html;
        ...
        if (is_numeric($_POST['id_gafete'])) {
            ...
            $email_user = $nombre['usuario'];
            $constancia_supra = AsistentesDao::getSupraByUserEmail($email_user);
        }
        ...
        if ($nombre['categoria_gafete'] == 3) {
            ...
            $cont_cards .= <<<html
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card">                        
                            <div class="card-body">
                                <h3 class="card-title mb-3">Congreso</h3>
                                <p class="card-text mb-1">(Profesor)</p>                            
                                {$btn_constancia_profesor}
                            </div>
                        </div>
                    </div>
    html;
